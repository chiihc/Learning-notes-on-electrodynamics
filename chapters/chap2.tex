...
\begin{align*}
    V_{\text{圆片}}&=\frac{\sigma }{2\varepsilon_0}\frac{r^2}{h+\sqrt{h^2+r^2}}\\
    V_{\text{半球北极}}&=\int_{0}^{2\pi}\dif\varphi\int_{0}^{\frac{\pi}{2}}\frac{\sigma R\sin\theta}{2\varepsilon_0}\frac{1}{\sqrt{R^2\left(1-\cos\theta\right)^2+R^2\sin^2\theta}}R^2\sin\theta\dif\theta\\
    &=2\pi\int_{0}^{\frac{\pi}{2}}\frac{\sigma \sin^2\theta}{2\varepsilon_0}\frac{1}{\sqrt{\left(1-\cos\theta\right)^2+\sin^2\theta}}R^2\dif\theta\\
    &=2\pi\int_{0}^{\frac{\pi}{2}}\frac{\sigma \sin^2\theta}{2\varepsilon_0}\frac{1}{\sqrt{2-2\cos\theta}}R^2\dif\theta\\
    &=2\pi\int_{0}^{\frac{\pi}{2}}\dfrac{\sigma 4\sin^2\dfrac{\theta}{2}\cos^2\dfrac{\theta}{2}}{2\sqrt{2}\varepsilon_0}\dfrac{1}{\sqrt{1-\cos^2\dfrac{\theta}{2}+\sin^2\dfrac{\theta}{2}}}R^2\dif\theta\\
    &=2\pi\int_{0}^{\frac{\pi}{2}}\dfrac{\sqrt{2}\sigma \sin^2\dfrac{\theta}{2}\cos^2\dfrac{\theta}{2}}{\varepsilon_0}\dfrac{1}{\sqrt{2\sin^2\dfrac{\theta}{2}}}R^2\dif\theta\\
    &=2\pi\int_{0}^{\frac{\pi}{2}}\dfrac{\sigma \sin\dfrac{\theta}{2}\cos^2\dfrac{\theta}{2}}{\varepsilon_0}R^2\dif\theta\\
    &=-4\pi\int_{0}^{\frac{\pi}{2}}\dfrac{\sigma \cos^2\dfrac{\theta}{2}}{\varepsilon_0}R^2\dif\cos\dfrac{\theta}{2}\\
    &=-4\pi\left.\dfrac{\sigma \cos^3\dfrac{\theta}{2}}{2\varepsilon_0}R^2\right|_{0}^{\frac{\pi}{2}}\\
    &=4\pi\dfrac{\sigma}{2\varepsilon_0}R^2
    -4\pi\dfrac{\sqrt{2}\sigma}{8\varepsilon_0}R^2\\
\end{align*}