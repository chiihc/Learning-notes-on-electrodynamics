...
\end{align*}
\mysssec{在一个真空二极管中, 电子从阴极面“热蒸发”后向阳极面加速运动, 阴极电势为零, 对面阳极的电势为$V_0$。在两极间隙中所形成的电子云(称为空间电荷)很快会达到一种分布状态, 使得阴极面上的电场为零。然后在两极板之间形成稳定的电流I。假定两个极板面积$A$远大于它们之间的距离$d$($A>>d$), 所以边界效应可以忽略。则$V, \rho, v$(电子速度)都仅是$x$的函数。\\
(a)写出在两极板之间空间的泊松方程。\\
(b)假定电子从阴极是从静止开始运动的, 那么在点$x$, 这里电势为$V(x)$, 电子速度为多少?\\
(c)在稳定状态下, 电流$I$不依赖于$x$。那么$\rho$和$v$之间的关系是什么?\\
(d)利用上面的结果, 消去$\rho$和$v$, 得出$V$满足的微分方程。\\
(e)作为$x, V_0, d$的函数, 求出$V$的解。并与没有空间电荷的情况比较。另外作为$x$的函
数, 求出$\rho$和$v$。\\
(f) 证明$1 =KV^\frac{3}{2}_0$
求出常数$K$。}
(a):
\begin{align*}
    \frac{\partial^2 V}{\partial x^2}=\frac{\rho}{\varepsilon_0}
\end{align*}
...
\begin{align*}
    \frac{\partial^2 V}{\partial x^2}&=\frac{\rho}{\varepsilon_0}\\
    \frac{\partial^2 V}{\partial x^2}&=\frac{I}{Av\varepsilon_0}\\
    \frac{\partial^2 V}{\partial x^2}&=\frac{I}{A\sqrt{\frac{2eV}{m}}\varepsilon_0}\\
    \end{align*}

    (e):
    \begin{align*}
    2\frac{\partial V}{\partial x}\frac{\partial^2 V}{\partial x^2}&=2\frac{\partial V}{\partial x}\frac{I}{A\sqrt{\frac{2eV}{m}}\varepsilon_0}\\
    \frac{\partial }{\partial x}\left(\frac{\partial V}{\partial x}\right)^2&=4\frac{\partial V^\frac{1}{2}}{\partial x}\frac{I}{A\sqrt{\frac{2e}{m}}\varepsilon_0}\\
    \left(\frac{\partial V}{\partial x}\right)^2&=4\frac{IV^\frac{1}{2}}{A\sqrt{\frac{2e}{m}}\varepsilon_0}\\
    \frac{\partial V}{\partial x}&=2\frac{I^\frac{1}{2}V^\frac{1}{4}}{A^\frac{1}{2}\left(\frac{2e}{m}\right)^\frac{1}{4}\varepsilon_0^\frac{1}{2}}\\
    V^{-\frac{1}{4}}{\partial V}{}&=2\frac{I^\frac{1}{2}{m}^\frac{1}{4}\partial x}{A^\frac{1}{2}(2e)^\frac{1}{4}\varepsilon_0^\frac{1}{2}}\\
    \frac{4}{3}V^{\frac{3}{4}}&=2\frac{I^\frac{1}{2}{m}^\frac{1}{4}x}{A^\frac{1}{2}(2e)^\frac{1}{4}\varepsilon_0^\frac{1}{2}}\\
    V&=\frac{3^{\frac{4}{3}}I^\frac{2}{3}x^{\frac{4}{3}}{m}^\frac{1}{4}}{2A^\frac{1}{2}e^\frac{1}{3}\varepsilon_0^\frac{2}{3}}\\
    v&=\sqrt{\frac{2eV}{m}}\\
    ...
    \rho&=\varepsilon_0\frac{\partial^2 V}{\partial x^2}\\
...
\begin{align*}
    V&=\frac{3^{\frac{4}{3}}I^\frac{2}{3}x^{\frac{4}{3}}{m}^\frac{1}{4}}{2A^\frac{1}{2}e^\frac{1}{3}\varepsilon_0^\frac{2}{3}}\\
    I^\frac{2}{3}&=\frac{V2A^\frac{1}{2}e^\frac{1}{3}\varepsilon_0^\frac{2}{3}}{3^{\frac{4}{3}}x^{\frac{4}{3}}{m}^\frac{1}{4}}\\
    I&=\frac{V^\frac{3}{2}2^\frac{3}{2}A^\frac{3}{4}e^\frac{1}{2}\varepsilon_0^\frac{2}{3}}{3^2x^2{m}^\frac{3}{2}}\\
    I&=\frac{V_0^\frac{3}{2}2^\frac{3}{2}A^\frac{3}{4}e^\frac{1}{2}\varepsilon_0^\frac{2}{3}}{3^2d^2{m}^\frac{3}{2}}
\end{align*}
...
(a)电场是什么?\\
(b)求出一个点电荷的电势。\\
(c)对一个位于原点的点电荷, 证明$\oiint_S\boldsymbol{E}\cdot\dif\boldsymbol{S}+\frac{1}{\lambda^2}\iiint_VV\dif\tau =\frac{q}{\varepsilon_0}$\\
(d)证明$\oiint_S\boldsymbol{E}\cdot\dif\boldsymbol{S}+\frac{1}{\lambda^2}\iiint_VV\dif\tau =\iiint_V\frac{\rho}{\varepsilon_0}\dif\tau$
}
(a):
\begin{align*}
    \boldsymbol{E}&=\dfrac{q}{4\pi\varepsilon_0r^2}\left(1+\frac{r}{\lambda}\right)e^{-\frac{r}{\lambda}}\boldsymbol{e}_r
    % \boldsymbol{\nabla}\cdot\boldsymbol{E}&=\frac{1}{r^2}\dfrac{\partial r^2\dfrac{q}{4\pi\varepsilon_0r^2}\left(1+\frac{r}{\lambda}\right)e^{-\frac{r}{\lambda}}}{\partial r}\\
    % &=\frac{q}{r^2 4\pi\varepsilon_0}\dfrac{\partial\left(1+\frac{r}{\lambda}\right)e^{-\frac{r}{\lambda}}}{\partial r}\\
    % &=-\frac{q}{r^2 4\pi\varepsilon_0}\frac{re^{-\frac{r}{\lambda}}}{\lambda^2}\\
    % &=-\frac{qe^{-\frac{r}{\lambda}}}{r 4\pi\varepsilon_0\lambda^2}\\
\end{align*}

(b):
\begin{align*}
    V&=\int_{R}^{\infty}\dfrac{q}{4\pi\varepsilon_0r^2}\left(1+\frac{r}{\lambda}\right)e^{-\frac{r}{\lambda}}\dif r\\
...
\begin{align*}
    ...
    \frac{1}{\lambda^2}\iiint_VV\dif\tau&=4\pi\frac{1}{\lambda^2}\int_0^Re^{-\frac{r}{\lambda}}\dfrac{q}{4\pi\varepsilon_0r}r^2\dif r\\
    ...
    +\dfrac{q}{\varepsilon_0}\\
     \frac{q}{\varepsilon_0}&=\oiint_S\boldsymbol{E}\cdot\dif\boldsymbol{S}+\frac{1}{\lambda^2}\iiint_VV\dif\tau
\end{align*}
