...
假设哑铃沿$x$方向运动，在推迟时刻（瞬时）静止,推迟位置$x(t_r)$距离
当前位置$x(t)$为$l$。（A）在（B）处产生的电场是
\begin{align}
    E_{AB}&=\frac{q\left|\boldsymbol{r}-\boldsymbol{r}_s\right|}{4\pi\varepsilon_0} \frac{c^2\boldsymbol{u}+\left(\boldsymbol{r}-\boldsymbol{r}_s\right)\times\left(\boldsymbol{u}\times\boldsymbol{a}\right)}{\left[(\boldsymbol{r}-\boldsymbol{r}_s)\cdot\boldsymbol{u}\right]^3}\nonumber\\
    E_{AB}&=\frac{q\left|\boldsymbol{r}-\boldsymbol{r}_s\right|}{4\pi\varepsilon_0} \frac{c^2\boldsymbol{u}+\left(\boldsymbol{r}-\boldsymbol{r}_s\right)\times\left(\boldsymbol{u}\times\boldsymbol{a}\right)}{\left[c\left|\boldsymbol{r}-\boldsymbol{r}_s\right|\right]^3}\nonumber\\
    F_{\text{自}}&=\frac{q(lc^2-ad^2)}{8\pi\varepsilon_0c^2\left(l^2+d^2\right)^\frac{3}{2}}\boldsymbol{e}_x\\
\end{align}
