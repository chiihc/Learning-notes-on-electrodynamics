...
\begin{align*}
    ...
    \boldsymbol{A}&\cong-\frac{d_0\mu_0\omega^2\cos\theta d}{4\pi rc^2}
    \cos\left(\omega t_0\right)
\end{align*}
...
\begin{align*}
    ...
    \cos\left(\omega t_0\right)+\frac{\partial \frac{d_0\mu_0\omega^2\cos\theta d}{4\pi rc^2}
    \cos\left(\omega t_0\right)}{\partial t}\\
    \boldsymbol{E}&=\frac{d_0\omega^2d}{4\pi c^2}\left[\boldsymbol{\nabla}\frac{\cos^2\theta }{\varepsilon_0r}
    \cos\left(\omega t_0\right)
    -\frac{\mu_0\omega\cos\theta
    \sin\left(\omega t_0\right)}{r}\right]\\
\end{align*}