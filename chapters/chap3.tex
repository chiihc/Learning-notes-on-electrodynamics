...
\begin{align*}
    qs&=4\pi\varepsilon_0 a^3 E_0\\
    U&=\frac{4\pi\varepsilon_0 a^3l}{qs} 
\end{align*}
...
\begin{align*}
    ...
    \boldsymbol{E}&=\dfrac{\partial U}{\partial s}\boldsymbol{e}_s+\dfrac{1}{s}\dfrac{\partial U}{\partial \phi}\boldsymbol{e}_\phi\\
    \boldsymbol{E}&=-\dfrac{\partial \frac{a^2P}{2\varepsilon_0}s^{-1}\cos\phi}{\partial s}\boldsymbol{e}_s
    -\dfrac{1}{s}\dfrac{\partial \frac{a^2P}{2\varepsilon_0}s^{-1}\cos\phi}{\partial \phi}\boldsymbol{e}_\phi\\
    \boldsymbol{E}&=\frac{a^2P}{2\varepsilon_0}s^{-2}\cos\phi\boldsymbol{e}_s
    +\dfrac{1}{s}\frac{a^2P}{2\varepsilon_0}s^{-1}\sin\phi\boldsymbol{e}_\phi
\end{align*}
\begin{align*}
